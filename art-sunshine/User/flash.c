...
Beaufort_WindType default_windspeed_threshold = Fresh_gale ;
Beaufort_WindType default_wind_level = Hurricane;
Sensor_Status default_winddevice_status = LOST;
uint8_t default_interval_exception = 10;	/* 10 second */
uint16_t default_interval_normal = 60;   	/* 1 minuter */
uint32_t default_control_interval = (10 * 1000);
